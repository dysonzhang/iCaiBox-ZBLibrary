...
public class SVProgressHUD {
	...
	public static void showWithMaskType(Context context,
	...
	public static void showWithProgress(Context context, String string,
			SVProgressHUDMaskType maskType) {
		getInstance(context).setMaskType(maskType);
	...
	public Animation getInAnimation() {
		int res = SVProgressHUDAnimateUtil.getAnimationResource(this.gravity,
				true);
