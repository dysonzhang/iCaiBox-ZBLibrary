...
public class BottomMenuUtil {
	...
	public static FunctionServiceBean FSB_SEND_MESSAGE = new FunctionServiceBean(NAME_SEND_MESSAGE,
			R.drawable.mail_light, INTENT_CODE_SEND_MESSAGE);
	public static FunctionServiceBean FSB_CALL = new FunctionServiceBean(NAME_CALL, R.drawable.call_light,
			INTENT_CODE_CALL);
	public static FunctionServiceBean FSB_SEND = new FunctionServiceBean(NAME_SEND, R.drawable.send_light,
			INTENT_CODE_SEND);
	public static FunctionServiceBean FSB_QRCODE = new FunctionServiceBean(NAME_QRCODE, R.drawable.qrcode,
			INTENT_CODE_QRCODE);
	// public static FunctionServiceBean FSB_SETTING = new
	// FunctionServiceBean(NAME_SETTING, R.drawable.setting_light,
	// INTENT_CODE_SETTING);
	public static FunctionServiceBean FSB_ADD_TO = new FunctionServiceBean(NAME_ADD_TO, R.drawable.add_light,
			INTENT_CODE_ADD_TO);
	public static FunctionServiceBean FSB_EDIT = new FunctionServiceBean(NAME_EDIT, R.drawable.edit_light,
			INTENT_CODE_EDIT);
	public static FunctionServiceBean FSB_EDIT_ALL = new FunctionServiceBean(NAME_EDIT_ALL, R.drawable.edit_light,
			INTENT_CODE_EDIT_ALL);
	public static FunctionServiceBean FSB_DELETE = new FunctionServiceBean(NAME_DELETE, R.drawable.delete_light,
			INTENT_CODE_DELETE);
	public static FunctionServiceBean FSB_SEND_EMAIL = new FunctionServiceBean(NAME_SEND_EMAIL, R.drawable.mail_light,
			INTENT_CODE_SEND_EMAIL);
