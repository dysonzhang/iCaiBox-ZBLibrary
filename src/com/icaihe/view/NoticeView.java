 ...
 *
 */
public class NoticeView extends BaseView<Notice> implements OnClickListener {
	private static final String TAG = "NoticeView";

	public NoticeView(Activity context, Resources resources) {
	...
	@Override
	public void setView(Notice data) {
		if (data == null) {
