...
public class SQLHelper extends SQLiteOpenHelper {
	...
	public static final String TABLE_NAME = "icaihe_db";
	public static final String COLUMN_ID = "_id";// long类型的id不能自增，primary key
													// autoincrement会出错
	...
	public void onCreate(SQLiteDatabase db) {
		String sql = "CREATE TABLE " + TABLE_NAME + " (" + COLUMN_ID + " INTEGER primary key autoincrement, "
				+ COLUMN_NAME + " text, " + COLUMN_PHONE + " text, " + COLUMN_MAIL + " text, " + COLUMN_OTHER
				+ " text)";
	...
	public int update(String column, String value, ContentValues values) {
		SQLiteDatabase db = this.getWritableDatabase();
		try {
			return db.update(TABLE_NAME, getCorrectValues(values), getSelection(column),
					getSelectionArgs(column, value));
		} catch (Exception e) {
